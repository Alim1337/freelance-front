...
import {
  ...
  ChevronRight, Users, Award, CreditCard
} from 'lucide-react'

const STATS = [
  { value: '58', label: 'Wilayas couvertes', icon: Award },
  { value: '100%', label: 'Algérien', icon: Users },
  { value: 'Chargily', label: 'Paiement sécurisé', icon: CreditCard },
  { value: 'Gratuit', label: 'Inscription', icon: Star },
]

const CATEGORIES = [
  { name: 'Informatique', sub: 'Dév web · Mobile · DevOps', icon: Code2, color: '#6c63ff' },
  { name: 'Design', sub: 'Graphisme · UI/UX · Vidéo', icon: Palette, color: '#ff6b6b' },
  { name: 'Architecture', sub: 'Intérieur · Plans 3D · BIM', icon: Building2, color: '#00d9a3' },
  { name: 'Marketing', sub: 'SEO · Réseaux · Rédaction', icon: Megaphone, color: '#ffb347' },
  { name: 'Formation', sub: 'Cours · Tutorat · Coaching', icon: BookOpen, color: '#a78bfa' },
  { name: 'Comptabilité', sub: 'Fisc · Paie · Conseil', icon: Calculator, color: '#34d399' },
]
    ...
    <div style={{ paddingTop: '64px' }}>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 mb-8 px-4 py-2 rounded-full text-sm font-medium animate-fade-up"
            ...
            Plateforme freelance 100% algérienne
          </div>
          ...
          <p className="text-lg sm:text-xl mb-10 max-w-2xl mx-auto animate-fade-up delay-200"
            ...
            Des freelances et organismes qualifiés en Algérie — développement, design, marketing,
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {CATEGORIES.map(({ name, sub, icon: Icon, color }) => (
              <Link key={name}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle max-w-xl mx-auto">
              Pensé pour les besoins et la réalité du marché algérien.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { icon: CreditCard, color: 'var(--accent3)', title: 'Paiement via Chargily', desc: 'Paiement sécurisé par CIB et BaridiPay. L\'argent est libéré uniquement à la livraison.' },
          ...
          <div className="card p-12 relative overflow-hidden text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg mb-8" style={{ color: 'var(--text-muted)' }}>
                Rejoignez des professionnels algériens sur FreelanceDZ.
              </p>
      ...
      <footer className="py-10 px-4" style={{ borderTop: '1px solid var(--border)' }}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>© 2026 FreelanceDZ. Fait avec ♥ en Algérie.</p>
          <div className="flex gap-4">
            {['Confidentialité', 'CGU', 'Contact'].map(l => (
              <Link key={l} href="#" className="text-sm" style={{ color: 'var(--text-muted)' }}>{l}</Link>
            ))}
          </div>
        </div>
      </footer>
